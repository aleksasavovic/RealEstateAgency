...
@Component({
  selector: 'app-show-users-waiting-for-aproval',
  templateUrl: './show-users-waiting-for-aproval.component.html',
  styleUrls: ['./show-users-waiting-for-aproval.component.css']
})
export class ShowUsersWaitingForAprovalComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.userService.getUsersWaitingForAproval().subscribe((u:User[])=>{
      this.users=u;
